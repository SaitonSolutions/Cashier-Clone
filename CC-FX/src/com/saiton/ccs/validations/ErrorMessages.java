...
public class ErrorMessages {
    ...
    // --Error Messages list.
    public static final String InvalidCustomerName = "Invalid Customer Name";
    public static final String InvalidWarrentyNo = "Invalid Warrenty Number";
    public static final String InvalidItemCode = "Invalid Item Code";
    public static final String InvalidWarrentyPeriod = "Invalid Warrenty Period";
    ...
    public static final String NotSuccesfullyReleased
            = "Room not not successfully released.";
    ...
    public static final String InvalidData = "Invalid invalid data.";
    ...
    public static final String InvalidQty = "Quentity should be a number";
    ...
    public static final String InvalidPaxQty = "Invalid Pax Quentity";
    ...
    public static final String LateCheckout
            = "Customer is late checkout please add late checkout charges.";
    ...
    public static final String SelectElement
            = "Select at least 2 checkboxes for half boad.";
    ...
    public static final String NoItemFound = "No item found.";
    ...
    public static final String AdvanceIdNotExist
            = "Advance Id Not Exist In The System. Please Select A Valid One";
    public static final String HighUsedQty
            = "Used Quantity can not be grater than availabel quantity.";
    public static final String NoData = "No data added to delete.";
    ...
    //-------BOT Error messages------------------
    public static final String NoBOT = "There is no BOT Records to delete";

    //-------KOT Error messages------------------
    public static final String NoKOT = "There is no KOT Records to delete";
    ...
    public static final String OverlapNumber
            = "To room number should be grater than From room no";
    ...
    public static String PasswordsMismatch = "Passwords and Confirm Mistmatch";
